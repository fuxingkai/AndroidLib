...
import frank.basis.log.LogLevel;
...
final class LoggerPrinter implements Printer {
     ...
     *
     * @param tag is the given string which will be used in QLog
     */
    @Override
    ...
    /**
     * call the method save(),depends the result,print different message
     *
     ...
     */
    @Override
    public void file(File targetDirectory, String fileName, String message) {

        fileName = (fileName == null) ? getFileName() : fileName;
        if (save(targetDirectory, fileName, message)) {
            d(" save log success ! location is >>>" + targetDirectory.getAbsolutePath() + "/" + fileName);
        } else {
            e("save log fails !");
        }
    }
     ...
     * @return
     */
    private boolean save(File dic, String fileName, String msg) {
    ...
    private String getFileName() {
        ...
        return "QLog_" + Long.toString(System.currentTimeMillis() + random.nextInt(10000)).substring(4) + ".txt";
    }
    ...
    private int getStackOffset(StackTraceElement[] trace) {
        for (int i = MIN_STACK_OFFSET; i < trace.length; i++) {
            ...
            if (!name.equals(LoggerPrinter.class.getName()) && !name.equals(QLog.class.getName())) {
                return --i;
            }
        }
        return -1;
