...
import frank.basis.http.encryp.Encoder;
 ...
 */
public class Hex {
	private static final Encoder encoder = new frank.basis.http.encryp.HexEncoder();
	...
	public static String toHexString(byte[] paramArrayOfByte, int paramInt1,
		...
		return frank.basis.http.encryp.Strings.fromByteArray(arrayOfByte);
	}
