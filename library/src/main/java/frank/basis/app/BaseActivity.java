...
public abstract class BaseActivity extends RxActivity {
    ...
    private frank.basis.utils.SystemBarTintManager tintManager;//沉浸式控制类
    protected frank.basis.ui.LoadingDialog loadingDlg;//加载弹出
    ...
    public void openTitleBarSetting() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            frank.basis.utils.Utils.setTranslucentStatus(this, true);
            // 创建状态栏的管理实例
            tintManager = new frank.basis.utils.SystemBarTintManager(this);
            // 激活状态栏设置
    ...
    protected void initLoadDlg(){
        if(null == loadingDlg){
            loadingDlg = new frank.basis.ui.LoadingDialog(this);
        }
    }
