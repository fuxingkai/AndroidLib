...
import frank.basis.utils.recovery.callback.RecoveryActivityLifecycleCallback;
import frank.basis.utils.recovery.callback.RecoveryCallback;
import frank.basis.utils.recovery.exception.RecoveryException;
import frank.basis.utils.recovery.tools.RecoveryLog;
 ...
 * .init(this);
 * <p>
 * 手动保存的异常信息在sdcard根目录的recovery_crash文件夹内
 * <p>
