...
import static cn.infrastructure.downloader.bizs.DLCons.DBCons.TB_COMPLETE;
import static cn.infrastructure.downloader.bizs.DLCons.DBCons.TB_TASK_CURRENT_BYTES;
import static cn.infrastructure.downloader.bizs.DLCons.DBCons.TB_TASK_DIR_PATH;
import static cn.infrastructure.downloader.bizs.DLCons.DBCons.TB_TASK_DISPOSITION;
import static cn.infrastructure.downloader.bizs.DLCons.DBCons.TB_TASK_ETAG;
import static cn.infrastructure.downloader.bizs.DLCons.DBCons.TB_TASK_FILE_NAME;
import static cn.infrastructure.downloader.bizs.DLCons.DBCons.TB_TASK_LOCATION;
import static cn.infrastructure.downloader.bizs.DLCons.DBCons.TB_TASK_MIME_TYPE;
import static cn.infrastructure.downloader.bizs.DLCons.DBCons.TB_TASK_TOTAL_BYTES;
import static cn.infrastructure.downloader.bizs.DLCons.DBCons.TB_TASK_URL_BASE;
