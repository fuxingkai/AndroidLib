...
import static cn.infrastructure.downloader.bizs.DLCons.Base.DEFAULT_TIMEOUT;
import static cn.infrastructure.downloader.bizs.DLCons.Base.LENGTH_PER_THREAD;
import static cn.infrastructure.downloader.bizs.DLCons.Base.MAX_REDIRECTS;
import static cn.infrastructure.downloader.bizs.DLCons.Code.HTTP_MOVED_PERM;
import static cn.infrastructure.downloader.bizs.DLCons.Code.HTTP_MOVED_TEMP;
import static cn.infrastructure.downloader.bizs.DLCons.Code.HTTP_NOT_MODIFIED;
import static cn.infrastructure.downloader.bizs.DLCons.Code.HTTP_OK;
import static cn.infrastructure.downloader.bizs.DLCons.Code.HTTP_PARTIAL;
import static cn.infrastructure.downloader.bizs.DLCons.Code.HTTP_SEE_OTHER;
import static cn.infrastructure.downloader.bizs.DLCons.Code.HTTP_TEMP_REDIRECT;
import static cn.infrastructure.downloader.bizs.DLError.ERROR_CREATE_FILE;
import static cn.infrastructure.downloader.bizs.DLError.ERROR_OPEN_CONNECT;
import static cn.infrastructure.downloader.bizs.DLError.ERROR_UNHANDLED_REDIRECT;
