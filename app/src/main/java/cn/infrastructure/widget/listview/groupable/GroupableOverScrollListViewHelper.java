...
import cn.infrastructure.widget.listview.PullToLoadMoreFooterView;
import cn.infrastructure.widget.listview.PullToRefreshHeaderView;

/**
 * delegate for GroupableOverScrollListView
 * 
...
/* package */ class GroupableOverScrollListViewHelper implements IOverScrollListViewSetting {
    ...
    public void usePullToRefresh(int layoutResId) {
        ...
        if (layoutResId != 0) {
            mPullToRefreshHeaderView = (PullToRefreshHeaderView) LayoutInflater
    ...
    public void usePullToLoadMore(int layoutResId) {
        ...
        if (layoutResId != 0) {
            mPullToLoadMoreFooterView = (PullToLoadMoreFooterView) LayoutInflater
                    .from(getContext()).inflate(layoutResId, null);
            mListView.setPullToLoadMoreFooterView(mPullToLoadMoreFooterView);
        } else {
            usePullToLoadMore();
