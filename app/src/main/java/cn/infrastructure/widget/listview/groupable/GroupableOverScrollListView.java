...
public class GroupableOverScrollListView extends ExpandableListView {
    ...
    public final static int DEFAULT_FINISH_DELAYED_DURATION = 800;
    ...
    public GroupableOverScrollListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
...
//            setSelection(0);
    ...
    public void finishRefreshingSuccess(final Runnable runnable, long delayedDuration) {
        if (mOrigHeaderView != null) {
    ...
    public void finishRefreshingFailed(final Runnable runnable, long delayedDuration) {
        if (mOrigHeaderView != null) {
