...
import cn.infrastructure.utils.recovery.tools.Constants;
import cn.infrastructure.utils.recovery.tools.DefaultHandlerUtil;
import cn.infrastructure.utils.recovery.tools.RecoverySharedPrefsUtil;
import cn.infrastructure.utils.recovery.tools.RecoveryUtil;
import cn.infrastructure.utils.recovery.tools.SaveCrashInfoUtils;
...
final class RecoveryHandler implements Thread.UncaughtExceptionHandler {
    ...
    public synchronized void uncaughtException(Thread t, Throwable e) {
        ...
        SaveCrashInfoUtils.saveErrorInfoToDB(Recovery.getInstance().getContext(), e);
    ...
    private void recover() {
        //当距离上次错误发生时间小于1分钟时，直接退出应用，避免连锁错误导致死循环问题
