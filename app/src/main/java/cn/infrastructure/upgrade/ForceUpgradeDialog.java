...
import cn.infrastructure.ui.OnDialogButtonClickListener;

import java.io.File;

import cn.infrastructure.downloader.bizs.DLError;
    ...
    public void onPrepare() {
        ...
        mBtnRight.post(new Runnable() {
            ...
            public void run() {
                ...
                mBtnRight.setText(UpgradeText.TEXT_UPGRADE_ONGOING);
