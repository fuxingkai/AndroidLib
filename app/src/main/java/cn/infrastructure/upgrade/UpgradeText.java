...
/* package */ class UpgradeText {
    ...
    public static final String TEXT_NOTIFICATION_CONTENT_DOWNLOAD_COMPLETE = TEXT_DOWNLOAD_COMPLETE;
    ...
    public static final String TEXT_DOWNLOAD_ERROR_NETWORK_NOT_AVAILABLE = "无网络连接";
