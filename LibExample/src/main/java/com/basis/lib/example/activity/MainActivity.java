package com.basis.lib.example.activity;
...
import frank.basis.app.BaseActivity;
import frank.basis.http.MediaTypeConst;
import frank.basis.http.PRequestBody;
import frank.basis.http.RROClient;
import frank.basis.http.encryp.HearderType;
import frank.basis.http.entity.Request;
import frank.basis.http.listener.UlPListener;
...
public class MainActivity extends BaseActivity {
    ...
    @Override
    protected void init() {
        client = AppApplication.instance.getRROClient();
        postDefault();
        uploadeFile();
    }
